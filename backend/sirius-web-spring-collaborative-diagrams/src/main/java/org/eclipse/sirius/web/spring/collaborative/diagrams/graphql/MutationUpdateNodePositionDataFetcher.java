...
public class MutationUpdateNodePositionDataFetcher implements IDataFetcherWithFieldCoordinates<IPayload> {
    ...
    public MutationUpdateNodePositionDataFetcher(IDataFetchingEnvironmentService dataFetchingEnvironmentService, IProjectEventProcessorRegistry projectEventProcessorRegistry,
